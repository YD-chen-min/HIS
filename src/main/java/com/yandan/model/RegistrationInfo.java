...
public class RegistrationInfo {
    ...
    public RegistrationInfo(String id, String cardId, int costType, int type, String deptId, String doctorId, float initialCost, float finalCost, int firstOrLast, int status, float roundingAmount) {
        this.id = id;
        this.cardId = cardId;
