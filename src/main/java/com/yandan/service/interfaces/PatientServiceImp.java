...
public interface PatientServiceImp {
     ...
     * @return
     */
    List<PatientInfo> getPatientInfos(HashMap<String,Object> paramMap);
     ...
     * @return
     */
    int insertPatientInfo(HashMap<String,Object> paramMap);
     ...
     * @return
     */
    int updatePatientInfo(HashMap<String,Object> paramMap);
