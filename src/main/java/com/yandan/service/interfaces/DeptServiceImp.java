...
public interface DeptServiceImp {
     ...
     * @return
     */
    List<DeptInfo> getDeptInfos(HashMap<String,Object> paramMap);
    /**
     ...
     * @return
     */
    int insertDeptInfo(HashMap<String,Object> paramMap);
     ...
     * @return
     */
    int updateDeptInfo(HashMap<String,Object> paramMap);
     ...
     * @return
     */
    int deleteDeptInfo(List<String> Ids);
}
